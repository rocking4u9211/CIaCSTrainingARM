...
$resourceGroupName = "amitCIaCS-rg"  #provide resource group name
...
# $templateFileURI = 'https://raw.githubusercontent.com/amitVerity/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
# $parametersFileURI = 'https://raw.githubusercontent.com/amitVerity/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
